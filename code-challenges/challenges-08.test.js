...
const filterStringsWithVowels = (arr) => {
  ...
  //return arr.filter((vowels) => vowels.match(regex));
  let odds = arr.filter(vowels => vowels.match(regex));
  return odds;
...
const notInFirstArray = (forbiddenValues, arr) => {
  ...
  let newArray = arr.filter(numbers => !forbiddenValues.includes(numbers))
  return newArray;
};
