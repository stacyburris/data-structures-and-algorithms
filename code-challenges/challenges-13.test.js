...
const standardizePhoneNumbers = (arr) => {
  ...
  let newNumber = [];
  arr.forEach(number => {
    let firstThree = number.substr(1, 3);
    let secondThree = number.substr(6, 3);
    let lastFour = number.substr(10, 13);
    console.log(firstThree, secondThree, lastFour);
    let newSmashNumber = `${firstThree}${secondThree}${lastFour}`;
    newNumber.push(newSmashNumber);
